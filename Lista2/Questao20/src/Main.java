...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Digita as 3 notas do aluno: ");
        double nota1 = scan.nextDouble();
        double nota2 = scan.nextDouble();
        double nota3 = scan.nextDouble();

        CalcularMedia calcularMedia = new CalcularMedia(nota1, nota2, nota3);
        calcularMedia.calcularMedia();

        System.out.println("A média do aluno é: " + calcularMedia.getMedia() + "\n" + calcularMedia);
    }
}
